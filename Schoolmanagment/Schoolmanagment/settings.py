...
INSTALLED_APPS = [
    ...
    'managmentsystem' ##Second Changes App Name
]
...
ROOT_URLCONF = 'Schoolmanagment.urls'##Check Changes Project name
...
WSGI_APPLICATION = 'Schoolmanagment.wsgi.application'##Check Changes Project Name
